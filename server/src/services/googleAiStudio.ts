...
export const extractAssistantInputWithGoogleAi = async (
  ...
  const prompt = [
    ...
    '- check_appointment: user wants to see their OWN existing appointments ("randevum var mı", "randevuma bakar mısın"). Do NOT use this for questions about whether the clinic is open.',
    ...
    '- unknown: anything else, including questions like "açık mısınız", "çalışma saatleriniz nedir", "o gün açık mısınız". Use unknown for clinic availability/hours questions.',
    '',
