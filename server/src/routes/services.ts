...
router.post('/appointment-types/:id/materials', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), addServiceMaterialHandler);
router.post('/services/:id/materials', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), addServiceMaterialHandler);
router.put('/appointment-types/:id/materials', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), replaceServiceMaterialsHandler);
router.put('/services/:id/materials', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), replaceServiceMaterialsHandler);
router.put('/appointment-types/:id/materials/:materialId', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), updateServiceMaterialHandler);
router.put('/services/:id/materials/:materialId', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), updateServiceMaterialHandler);
router.delete('/appointment-types/:id/materials/:materialId', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), deleteServiceMaterialHandler);
router.delete('/services/:id/materials/:materialId', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), deleteServiceMaterialHandler);
router.post('/appointment-types', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), createServiceHandler);
router.post('/services', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), createServiceHandler);
router.put('/appointment-types/:id', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), updateServiceHandler);
router.put('/services/:id', authorize(['OWNER', 'ORG_ADMIN', 'CLINIC_MANAGER']), updateServiceHandler);
