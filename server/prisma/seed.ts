...
async function main() {
  ...
  const dentists = await Promise.all([
    prisma.user.create({ data: { clinicId: clinic.id, firstName: 'Dt. Kerem', lastName: 'Ozguler', email: 'kerem.ozguler@ailedis.com', role: 'doctor', passwordHash } }),
    ...
    prisma.user.create({ data: { clinicId: clinic.id, firstName: 'Dt. Aysegul', lastName: 'Akmese', email: 'aysegul.akmese@ailedis.com', role: 'doctor', passwordHash } }),
    ...
    prisma.user.create({ data: { clinicId: clinic.id, firstName: 'Dt. Batikan', lastName: 'Sirin', email: 'batikan.sirin@ailedis.com', role: 'doctor', passwordHash } }),
    prisma.user.create({ data: { clinicId: clinic.id, firstName: 'Dt. Ugur', lastName: 'Mester', email: 'ugur.mester@ailedis.com', role: 'doctor', passwordHash } }),
  ]);
  ...
  const services = [
    {
      name: 'Estetik Dis Hekimligi',
      durationMinutes: 60,
      color: colors.pink,
      category: 'Estetik',
      basePrice: null,
      description: 'Gulus tasarimi, zirkonyum kaplama ve beyazlatma gibi estetik odakli planlamalar.',
    },
    {
      ...
      category: 'Cerrahi',
      basePrice: null,
      description: 'Dis eksiklikleri icin implant uygunluk gorusmesi ve tedavi plani hazirligi.',
    },
    {
      name: 'Agiz, Dis ve Cene Cerrahisi',
      durationMinutes: 60,
      color: colors.red,
      category: 'Cerrahi',
      basePrice: null,
      description: 'Gomulu dis, cekim ve cerrahi islem oncesi degerlendirme randevusu.',
    },
    {
      name: 'Ortodonti (Dis Teli)',
      durationMinutes: 45,
      color: colors.amber,
      category: 'Ortodonti',
      basePrice: null,
      description: 'Dis dizilimi, kapanis ve seffaf plak/braket secenekleri icin ortodonti gorusmesi.',
    },
    {
      ...
      category: 'Endodonti',
      basePrice: null,
      description: 'Dogal disi korumaya yonelik kanal tedavisi planlama ve uygulama randevusu.',
    },
    {
      name: 'Pedodonti (Cocuk Dis Hekimligi)',
      durationMinutes: 45,
      color: colors.green,
      category: 'Cocuk Dis Hekimligi',
      basePrice: null,
      description: 'Cocuk hastalar icin koruyucu ve konfor odakli dis hekimligi randevulari.',
    },
    {
      name: 'Periodontoloji (Dis Eti Tedavisi)',
      durationMinutes: 45,
      color: colors.teal,
      category: 'Dis Eti',
      basePrice: null,
      description: 'Dis eti kanamasi, cekilme ve periodontal takip surecleri.',
    },
    {
      name: 'Protetik Dis Tedavisi',
      durationMinutes: 75,
      color: colors.slate,
      category: 'Protetik',
      basePrice: null,
      description: 'Kron, kopru ve protez planlamasi ile fonksiyon ve estetik geri kazanim surecleri.',
    },
    {
      name: 'Kompozit Dolgu',
      durationMinutes: 45,
      ...
      category: 'Restoratif',
      basePrice: null,
      description: 'Dogal dis gorunumunu koruyan estetik ve dayanikli dolgu uygulamalari.',
    },
    {
      name: 'Gulus Tasarimi',
      durationMinutes: 60,
      ...
      category: 'Estetik',
      basePrice: null,
      description: 'Gulus estetik beklentileri ve agiz sagligi ihtiyaclarini birlikte ele alan planlama.',
    },
    {
      ...
      basePrice: null,
      description: 'Dogal gorunum ve dayaniklilik hedefleyen zirkonyum kaplama planlama randevusu.',
    },
    {
      name: 'Dis Beyazlatma Bleaching',
      durationMinutes: 60,
      color: colors.blue,
      category: 'Estetik',
      basePrice: null,
      description: 'Dis renginin acilmasi icin profesyonel beyazlatma degerlendirmesi ve uygulamasi.',
    },
  ];
