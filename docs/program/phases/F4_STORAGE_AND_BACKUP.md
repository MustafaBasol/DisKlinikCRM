...
- **Migration yaratılmadı.** İki gerçek şema boşluğu tespit edildi ve program
  ...
  **Güncelleme (F4-3-R2, 2026-08-16):** `R-079` program sahibinin yetkisiyle
  ayrı bir turda kapatıldı (aşağıdaki F4-3-R2 bölümü). `R-080` **açık kalır** —
...
| `server/package.json` | `test:lab-attachment-legal-hold`; **CI kapısı** olarak `server:test:non-disposable` ve `test` zincirlerine eklendi |
