...
| F0-006 | Production Topology and Configuration Verification | `AGENT_COMPLETED` — [PRODUCTION_TOPOLOGY.md](../PRODUCTION_TOPOLOGY.md), [ENVIRONMENT_MATRIX.md](../ENVIRONMENT_MATRIX.md), [evidence/F0-006_PRODUCTION_TOPOLOGY_EVIDENCE.md](../evidence/F0-006_PRODUCTION_TOPOLOGY_EVIDENCE.md), [evidence/F0-006_configuration_inventory.json](../evidence/F0-006_configuration_inventory.json). Process/deployment/config/storage/backup topology traced at source-code level and reconciled against F0-002 Stage B; 12 new risks (R-029…R-040) recorded in [RISK_REGISTER.md](../RISK_REGISTER.md). |
