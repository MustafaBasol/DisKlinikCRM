...
Faz durumu: `IN_PROGRESS` · Son güncelleme: 2026-07-19 (F0-006 tamamlandı — production topology/configuration doğrulaması; F0-002'nin kendi `MERGED` durumu düzeltildi — bkz. PR #172)
...
| F0-006 | Production Topology and Configuration Verification | `PR_OPEN` — [PR #173](https://github.com/MustafaBasol/DisKlinikCRM/pull/173) opened, base `main`. [PRODUCTION_TOPOLOGY.md](../PRODUCTION_TOPOLOGY.md), [ENVIRONMENT_MATRIX.md](../ENVIRONMENT_MATRIX.md), [evidence/F0-006_PRODUCTION_TOPOLOGY_EVIDENCE.md](../evidence/F0-006_PRODUCTION_TOPOLOGY_EVIDENCE.md), [evidence/F0-006_configuration_inventory.json](../evidence/F0-006_configuration_inventory.json). Process/deployment/config/storage/backup topology traced at source-code level and reconciled against F0-002 Stage B; 12 new risks (R-029…R-040) recorded in [RISK_REGISTER.md](../RISK_REGISTER.md). |
