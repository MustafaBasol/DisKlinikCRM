...
| F0-002 | Repository and Deployment Baseline Inventory | `PR_OPEN` — [PR #172](https://github.com/MustafaBasol/DisKlinikCRM/pull/172) opened, base `main`. Stage A (repository evidence) and Stage B (production baseline evidence, supplied 2026-07-19T13:43:12+03:00) both complete; see [evidence/F0-002_REPOSITORY_BASELINE.md](../evidence/F0-002_REPOSITORY_BASELINE.md) and [evidence/F0-002_PRODUCTION_BASELINE_EVIDENCE.md](../evidence/F0-002_PRODUCTION_BASELINE_EVIDENCE.md). Merge decision is external review's. |
