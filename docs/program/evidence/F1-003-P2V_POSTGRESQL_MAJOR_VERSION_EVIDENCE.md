...
- `docs/program/NORAMEDI_MASTER_TRACKER.md` — F1-003-P2 status confirmed `not started`; no PostgreSQL version claim.
...
- `docs/program/phases/F1_CI_AND_TEST_ARCHITECTURE.md` — F1-003-P2 status confirmed not started, not blocked on any further merge, not yet authorized to begin.
