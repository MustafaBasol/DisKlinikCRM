...
- **Yeni bulgu:** legacy `server:test` kendisi hiç değiştirilmedi, ancak zaten sessizce **23** DB-gerektiren script (§6'nın "3 örnek" iması yerine tam liste) + 1 ek MinIO-gerektiren script (`test:kvkk-lifecycle`) içerdiği tespit edildi — F1-003-P2'ye açık, çözülmemiş bir bulgu olarak devredildi.

Tam detay: [evidence/F1-003-P1_test_execution_contract.json](evidence/F1-003-P1_test_execution_contract.json) (114 kayıt), [evidence/F1-003-P1_TEST_SCRIPT_CLOSURE_AND_EXECUTION_CONTRACT.md](evidence/F1-003-P1_TEST_SCRIPT_CLOSURE_AND_EXECUTION_CONTRACT.md).
