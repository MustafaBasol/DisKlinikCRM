 ...
 */
const BridgeOnboardingCard: React.FC<BridgeOnboardingCardProps> = ({ loading, error, config, onStartSetup }) => {
      ...
      {!loading && !error && config?.enabled && config.installerAvailable && config.installer && (
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button onClick={onStartSetup} className="btn-primary flex items-center gap-1.5 text-sm">
