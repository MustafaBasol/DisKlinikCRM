...
export const PRIMARY_LATERAL: Readonly<Record<PrimaryAnatomyKey, LateralToothArt>> = {
  ...
  'primary:upper:second_molar': {
    crown:
      ...
      'C16.5 6.6 15.0 12.8 14.9 19.0 C16.0 20.3 18.0 22.0 19.8 23.5 ' +
      'C19.9 24.3 20.1 25.2 20.3 26.0 C27.5 26.7 36.5 26.7 43.7 26.0 ' +
      'C44.0 25.2 44.1 24.3 44.2 23.5 C44.6 22.0 45.4 20.3 46.1 19.0 ' +
      'C46.3 13.5 46.0 8 45.5 4.0 Z',
    roots: [
  ...
  'primary:lower:first_molar': {
    crown:
      ...
      'C18.5 6.4 17.8 11.8 17.7 17.0 C18.1 18.5 18.2 21 18.25 23.0 ' +
      'C18.3 24.5 19.7 26.0 21.35 27.0 C28 27.7 36 27.7 43.35 27.0 ' +
      'C44.0 26.0 45.4 24.5 46.45 23.0 C46.5 21 46.8 18.5 47.0 17.0 ' +
      'C46.3 11.8 45.5 6.4 42.0 4.0 Z',
    roots: [
  ...
  'primary:lower:second_molar': {
    crown:
      ...
      'C13.5 6.9 13.2 12.8 13.2 18.0 C13.5 19.5 13.7 20.4 13.9 21.0 ' +
      'C14.1 22.5 15.8 24.2 17.9 25.0 C25 25.7 39 25.7 46.1 25.0 ' +
      'C46.9 23.2 48.7 22 50.1 21.0 C50.3 20.4 50.6 19.5 50.8 18.0 ' +
      'C50.5 12.8 50.0 6.9 48.0 4.0 Z',
    roots: [
