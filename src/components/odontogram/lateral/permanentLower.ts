...
export const PERMANENT_LOWER_LATERAL: Readonly<Record<PermanentLowerKey, LateralToothArt>> = {
  ...
  'permanent:lower:first_molar': {
    ...
    roots: [
      ...
      'M33.0 24.0 C33.0 24.6 32.3 24.2 33.0 26.0 C33.8 28.0 37.1 36.1 39.2 40.2 ' +
        'C41.3 44.2 47.7 50.9 47.7 54.4 C47.7 57.3 39.9 62.5 38.9 64.0 ' +
        'C38.0 65.4 39.7 66.3 39.9 66.5 C40.1 66.3 40.7 66.3 41.0 66.5 ' +
        'C41.2 66.3 40.7 65.4 41.9 64.0 C43.2 62.5 50.7 57.3 51.6 54.4 ' +
        'C52.7 50.9 50.5 44.2 49.6 40.2 C48.7 36.1 45.9 28.0 45.3 26.0 ' +
        'C44.8 24.2 45.3 24.6 45.3 24.0 C43.9 23.8 34.4 23.8 33.0 24.0 Z',
      // distal — narrower, straighter, only a mild curl back near the apex
      'M21.1 24.0 C21.1 24.6 21.5 24.2 21.1 26.0 C20.6 28.0 18.1 36.1 17.3 40.2 ' +
        'C16.4 44.2 14.8 50.9 15.3 54.4 C15.7 57.3 19.7 62.5 20.4 64.0 ' +
        'C21.1 65.4 21.2 66.3 21.4 66.5 C21.6 66.3 22.2 66.3 22.5 66.5 ' +
        'C22.7 66.3 23.9 65.4 23.4 64.0 C22.9 62.5 18.2 57.3 18.4 54.4 ' +
        'C18.8 50.9 23.9 44.2 25.7 40.2 C27.5 36.1 30.3 28.0 31.0 26.0 ' +
        'C31.6 24.2 31.0 24.6 31.0 24.0 C29.9 23.8 22.2 23.8 21.1 24.0 Z',
    ],
    surface:
  ...
  'permanent:lower:second_molar': {
    ...
    roots: [
      'M33.0 22.5 C33.0 23.1 32.3 22.8 33.0 24.5 C33.7 26.4 36.9 33.9 38.9 37.6 ' +
        'C40.9 41.4 47.0 47.6 47.0 50.8 C47.0 53.5 39.5 58.1 38.6 59.5 ' +
        'C37.8 60.8 39.3 61.8 39.5 62.0 C39.8 61.8 40.4 61.8 40.6 62.0 ' +
        'C40.8 61.8 40.5 60.8 41.6 59.5 C42.8 58.1 49.8 53.5 50.8 50.8 ' +
        'C51.8 47.6 49.7 41.4 48.9 37.6 C48.0 33.9 45.3 26.4 44.8 24.5 ' +
        'C44.3 22.8 44.8 23.1 44.8 22.5 C43.5 22.3 34.3 22.3 33.0 22.5 Z',
      'M21.6 22.5 C21.6 23.1 22.0 22.8 21.6 24.5 C21.1 26.4 18.7 33.9 17.9 37.6 ' +
        'C17.1 41.4 15.5 47.6 16.0 50.8 C16.3 53.5 20.1 58.1 20.8 59.5 ' +
        'C21.5 60.8 21.6 61.8 21.8 62.0 C22.0 61.8 22.6 61.8 22.9 62.0 ' +
        'C23.1 61.8 24.3 60.8 23.8 59.5 C23.3 58.1 18.7 53.5 19.0 50.8 ' +
        'C19.3 47.6 24.2 41.4 25.9 37.6 C27.6 33.9 30.4 26.4 31.0 24.5 ' +
        'C31.6 22.8 31.0 23.1 31.0 22.5 C30.0 22.3 22.6 22.3 21.6 22.5 Z',
    ],
    surface:
