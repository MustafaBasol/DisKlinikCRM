...
export const PERMANENT_UPPER_LATERAL: Readonly<Record<PermanentUpperKey, LateralToothArt>> = {
  ...
  'permanent:upper:first_molar': {
    ...
    roots: [
      ...
      // mid-root excursion trimmed so the outer spread reads 0.85-1.05x crown
      // width against the reference plates, without moving the apex at all
      'M35.3 24.0 C35.3 24.6 34.9 24.6 35.3 26.0 C35.7 27.6 37.5 33.6 38.7 36.6 ' +
        'C39.8 39.7 43.6 44.8 43.7 47.3 C43.7 49.4 39.6 52.8 39.2 53.9 ' +
        'C38.8 54.9 39.9 56.2 40.1 56.4 C40.4 56.2 40.9 56.2 41.2 56.4 ' +
        'C41.4 56.2 41.6 54.9 42.2 53.9 C42.8 52.8 45.9 49.4 46.4 47.3 ' +
        'C47.0 44.8 46.4 39.7 46.0 36.6 C45.7 33.6 44.2 27.6 44.0 26.0 ' +
        'C43.8 24.6 44.0 24.6 44.0 24.0 C43.0 23.8 36.3 23.8 35.3 24.0 Z',
      // distobuccal — mirrors the mesiobuccal splay/curl toward the distal
      'M22.0 24.0 C22.0 24.6 22.2 24.6 22.0 26.0 C21.7 27.6 20.2 33.6 19.8 36.6 ' +
        'C19.3 39.7 18.4 44.8 18.9 47.3 C19.3 49.4 22.2 52.8 22.8 53.9 ' +
        'C23.4 54.9 23.6 56.2 23.8 56.4 C24.1 56.2 24.6 56.2 24.9 56.4 ' +
        'C25.1 56.2 26.3 54.9 25.8 53.9 C25.4 52.8 21.1 49.4 21.0 47.3 ' +
        'C21.0 44.8 24.4 39.7 25.5 36.6 C26.6 33.6 28.3 27.6 28.7 26.0 ' +
        'C29.1 24.6 28.7 24.6 28.7 24.0 C28.0 23.8 22.7 23.8 22.0 24.0 Z',
    ],
    surface:
  ...
  'permanent:upper:second_molar': {
    ...
    roots: [
      ...
      'M35.0 22.5 C35.0 23.1 34.6 23.2 35.0 24.5 C35.3 26.0 36.9 31.4 38.0 34.2 ' +
        'C39.1 36.9 42.5 41.6 42.5 43.8 C42.6 45.8 38.7 48.6 38.3 49.6 ' +
        'C38.0 50.5 39.1 51.9 39.3 52.1 C39.6 51.9 40.1 51.9 40.4 52.1 ' +
        'C40.6 51.9 40.8 50.5 41.3 49.6 C41.9 48.6 44.6 45.8 45.1 43.8 ' +
        'C45.6 41.6 45.0 36.9 44.7 34.2 C44.4 31.4 43.1 26.0 42.9 24.5 ' +
        'C42.7 23.2 42.9 23.1 42.9 22.5 C42.0 22.3 35.9 22.3 35.0 22.5 Z',
      'M23.1 22.5 C23.1 23.1 23.3 23.2 23.1 24.5 C22.8 26.0 21.5 31.4 21.1 34.2 ' +
        'C20.7 36.9 19.9 41.6 20.2 43.8 C20.6 45.8 23.1 48.6 23.7 49.6 ' +
        'C24.1 50.5 24.4 51.9 24.6 52.1 C24.9 51.9 25.4 51.9 25.7 52.1 ' +
        'C25.9 51.9 27.0 50.5 26.7 49.6 C26.2 48.6 22.2 45.8 22.1 43.8 ' +
        'C22.1 41.6 25.2 36.9 26.1 34.2 C27.1 31.4 28.7 26.0 29.0 24.5 ' +
  ...
  'permanent:upper:third_molar': {
    ...
    roots: [
      ...
      // mid-root excursion trimmed, same rationale as the first molar
      'M34.8 21.0 C34.8 21.6 34.5 21.8 34.8 23.0 C35.2 24.3 36.6 29.2 37.6 31.7 ' +
        'C38.6 34.2 41.8 38.5 41.9 40.5 C41.9 42.2 38.3 44.5 37.9 45.5 ' +
        'C37.6 46.3 38.7 47.7 38.9 48.0 C39.1 47.8 39.7 47.8 40.0 48.0 ' +
        'C40.2 47.7 40.4 46.3 40.9 45.5 C41.5 44.5 43.9 42.2 44.3 40.5 ' +
        'C44.7 38.5 44.3 34.2 44.0 31.7 C43.7 29.2 42.6 24.3 42.3 23.0 ' +
        'C42.2 21.8 42.3 21.6 42.3 21.0 C41.5 20.8 35.7 20.8 34.8 21.0 Z',
      'M23.5 21.0 C23.5 21.6 23.7 21.8 23.5 23.0 C23.3 24.3 22.1 29.2 21.7 31.7 ' +
        'C21.3 34.2 20.6 38.5 21.0 40.5 C21.2 42.2 23.5 44.5 24.0 45.5 ' +
        'C24.5 46.3 24.8 47.7 25.0 48.0 C25.2 47.8 25.8 47.8 26.1 48.0 ' +
        'C26.3 47.7 27.4 46.3 27.0 45.5 C26.6 44.5 22.8 42.2 22.8 40.5 ' +
        'C22.7 38.5 25.6 34.2 26.5 31.7 C27.4 29.2 28.8 24.3 29.2 23.0 ' +
        'C29.5 21.8 29.2 21.6 29.2 21.0 C28.6 20.8 24.2 20.8 23.5 21.0 Z',
    ],
